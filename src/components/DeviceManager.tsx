...
interface DeviceManagerProps {
  ...
  onUpdateSettings?: (disableReceipts: boolean) => Promise<void>;
  onUpdateProfile?: (displayName: string, avatarUrl: string, email?: string, bio?: string, phone?: string) => Promise<void>;
}
...
export default function DeviceManager({
  ...
  }, [user.displayName, user.avatarUrl, user.email, user.bio, user.phone]);
  ...
  return (
    <div className="flex flex-col h-full bg-[#0E121A] border-l border-slate-800/60 w-full max-w-sm overflow-y-auto shrink-0 select-none">
      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="p-4 rounded-xl bg-[#131722] border border-slate-800/60 flex flex-col gap-4">
          {!isEditingProfile ? (
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  <img
                    ...
                    className="w-14 h-14 rounded-full border border-sky-500/40 bg-[#1A1F2B] object-cover shrink-0"
                  />
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 border border-slate-800 hover:border-slate-700/80 text-[10px] font-bold font-mono tracking-wider uppercase text-sky-400 hover:text-sky-300 rounded-lg bg-[#0E121A] transition-all active:scale-95 shrink-0"
                >
                  Edit
                </button>
              </div>
              ...
              <div className="mt-2 pt-2 border-t border-slate-800/40 flex flex-col gap-2.5 text-xs">
            ...
            <form onSubmit={handleSaveProfile} className="flex flex-col gap-3 font-sans">
              <div className="text-[9.5px] font-bold text-sky-400 font-mono uppercase tracking-widest border-b border-slate-800/60 pb-1.5 mb-1 flex items-center justify-between">
                ...
                <span className="text-slate-500 text-[8px] font-normal font-sans tracking-normal capitalize">Secured encryption credentials</span>
              </div>
        ...
        <div className="p-4 rounded-xl bg-[#0A0C12] border border-slate-800 flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between p-2.5 mt-1 rounded-lg bg-[#11141F] border border-slate-800/45">
            ...
            <button
              onClick={() => {
                if (onUpdateSettings) {
                  onUpdateSettings(!user.disableReadReceipts);
                }
              }}
